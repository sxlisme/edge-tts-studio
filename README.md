...
声工坊是一款轻量文字转语音工作台，当前版本为 **1.6.0**。桌面端使用 Tauri 2 和 Rust，Android 端使用独立的 Kotlin 原生界面；两端都直接连接在线语音服务，不需要 Python 环境或单独部署后端。
...
- Android 原生版只提供文本输入、18 种常用音色、语速/音调/音量配置、试听和保存到下载目录
