...
声工坊是一款使用 Tauri 2 和 Rust 开发的轻量文字转语音工作台，当前版本为 **1.4.3**，提供 **322 种在线音色**，覆盖 75 种语言。应用直接连接在线语音服务，不需要 Python 环境，也不需要单独部署后端；界面、历史记录和导出的音频文件均由本地桌面应用管理。
...
- Android 端提供精简的文本输入、音色选择、语速/音调/音量配置、试听和系统文件导出
